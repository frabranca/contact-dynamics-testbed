...
#ifndef __frankalcm_robot_state_hpp__
#define __frankalcm_robot_state_hpp__
...
int robot_state::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int robot_state::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int robot_state::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t robot_state::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* robot_state::getTypeName()
{
    return "robot_state";
}

int robot_state::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->ext_force[0], 6);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->EFpose[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;

    return pos;
}

int robot_state::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->ext_force[0], 6);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->EFpose[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;

    return pos;
}

int robot_state::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
{
    uint64_t hash = 0x09b6a1ff0579662fLL;
