...
#ifndef __frankalcm_gripper_command_hpp__
#define __frankalcm_gripper_command_hpp__
...
int gripper_command::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int gripper_command::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int gripper_command::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t gripper_command::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* gripper_command::getTypeName()
{
    return "gripper_command";
}

int gripper_command::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int gripper_command::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
