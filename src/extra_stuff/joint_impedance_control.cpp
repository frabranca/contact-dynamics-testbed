...
// compile with: g++ -o impedance joint_impedance_control.cpp -lfranka -lpthread
  ...
  try {
    ...
    std::function<franka::Torques(const franka::RobotState&, franka::Duration)>
      ...
      std::array<double, 7> tau_d_rate_limited =
          franka::limitRate(franka:kMaxTorqueRate:kMaxTorqueRate, tau_d_calculated, state.tau_J_d);
