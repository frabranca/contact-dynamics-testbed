...
int main(int argc, char** argv) {
  ...
  lcm::LCM lcm;
  lcm::LCM::HandlerFunction<exlcm::command> func;
  ...
  func = [argc, argv](const lcm::ReceiveBuffer* rbuf, const std::string& channel,
            const exlcm::command* msg) {
            ...
            // print message 
            // for (int i = 0; i <7 ; i++)
	            // std::cout << msg->q_goal[i] <<std::endl;
            ...
            // INITIATE FUNCTION TO READ COMMANDS AND IMPLEMENT ON
            robot.control(
