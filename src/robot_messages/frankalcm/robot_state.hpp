...
int robot_state::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __boolean_encode_array(buf, offset + pos, maxlen - pos, &this->robot_enabled, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int robot_state::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __boolean_decode_array(buf, offset + pos, maxlen - pos, &this->robot_enabled, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
{
    uint64_t hash = 0x37cf422f6574ed5aLL;
